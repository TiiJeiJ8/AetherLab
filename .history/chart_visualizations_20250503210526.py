            ...
            if has_admin:
                ...
                try:
                    ...
                    if plot_df[latitude_col].isnull().all() or plot_df[longitude_col].isnull().all():
                        ...
                        raise ValueError("Latitude and longitude columns must be of numerical type")
                except Exception as e:
                    print(f'Latitude and longitude data processing error: {str(e)}')
                    traceback.print_exc()
                    return go.Figure(
                        layout={
                            'title': 'Latitude and longitude data error',
                            'xaxis': {'visible': False}, 'yaxis': {'visible': False},
                            'annotations': [{
