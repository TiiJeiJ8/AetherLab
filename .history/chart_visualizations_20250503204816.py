                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                ...
                                html.Div(id='line-bar-area-options', children=[ # Renamed Div for clarity
                                    ...
                                    dbc.Checkbox(id='show-mean-line', label="Display the mean line (not plotted for small amounts of data)", value=False, className="mb-1"),
                                    dbc.Checkbox(id='show-median-line', label="Display median line (small data size not plotted)", value=False, className="mb-3"),
        ...
        if custom_color_val:
            ...
            if custom_color_val.startswith('#') or custom_color_val.startswith('rgb') or custom_color_val.lower() in ['white', 'black', 'red', 'blue', 'green', 'yellow', 'orange', 'purple', 'grey', 'gray', 'lightgrey', 'lightgray', 'darkgrey', 'darkgray']:
                ...
                paper_bgcolor = custom_color_val
                 ...
                 print(f"Warning: The format of the custom background color '{custom_comlor_val}' may be invalid, and the default background will be used instead.")
                 plot_bgcolor = None
                 paper_bgcolor = None
        else: # 选了自定义但没输入 -> 默认
            plot_bgcolor = None
