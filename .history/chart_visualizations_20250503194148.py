...
chart_visualizations_layout = html.Div([
    ...
    dbc.Container([
        ...
        dbc.Row([
            ...
            dbc.Col([
                html.Button(
                    'Data Visualization', id='data-visualization-button', className="btn btn-primary btn-animated", disabled=True,
                    style={
                ...
                dbc.Button(
                    'Color Pale', id='color-scheme-button', href='https://coolors.co/palettes/trending', className="btn btn-primary btn-animated", disabled=False,
                    style={
                        'margin-top': '1.1rem', 'margin-right': '1rem',
