...
chart_visualizations_layout = html.Div([
    # Floating Home button in top-right corner
    html.Div(
        dbc.Button(
            "Home",
            href="/",
...
# Define callback to update URL

# Define a dictionnary to store the geo data
province_to_coordinate = {
    "北京": {'lat': 39.90469, 'lng': 116.40717},
    "北京市": {'lat': 39.90469, 'lng': 116.40717},
    "天津": {'lat': 39.125596, 'lng': 117.201993},
    "天津市": {'lat': 39.125596, 'lng': 117.201993},
    "上海": {'lat': 31.23037, 'lng': 121.473701},
    "上海市": {'lat': 31.23037, 'lng': 121.473701},
    #todo: More provinces and cities can be added here
}
                ...
                if chart_type == 'scatter_map':
                    ...
                    china_geojson = {
                        ...
                        "features": [
                            {
                                "type": "Feature",
                                "properties": {"name": "北京市", "id": "110000"},
                                "geometry": {"type": "Polygon", "coordinates": [[
                                    [116.058,40.392],[116.058,40.392],[116.058,40.392],[116.058,40.392]
                                ]]}
                            },
                        ]
                    }
