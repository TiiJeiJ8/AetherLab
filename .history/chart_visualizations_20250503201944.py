                            ...
                            dbc.CardBody([
                                ...
                                html.Div([
                                    ...
                                    html.Div(id='custom-ratio-inputs', style={'display': 'none'}, children=[
                                        ...
                                        dbc.Alert("Input values and the chart will be updated automatically (note that large values may cause the chart to overflow the screen)", color="info", className="mt-2", 
