                    ...
                    children=[
                        ...
                        dbc.Card([
                            ...
                            dbc.CardBody([
                                ...
                                dbc.Alert(
                                    "Tip: Choose the chart type that best fits your data visualization needs. For example, use a Line Chart for trends, a Bar Chart for comparisons, a Pie Chart for proportions, a Scatter Chart for relationships, and a Heatmap for density.",
                                    color="info",
                                    dismissable=True,
                                    className="small p-2"
                                )
