                        ...
                        dbc.Card([
                            ...
                            dbc.CardBody([
                                ...
                                html.Div(id='Formap', style={'display': 'none'}, children=[
                                    ...
                                    html.Div([html.Label("Province/City/District Column", className="text-secondary"),
                                            dcc.Dropdown(id='province-column', className="mb-3", placeholder="Select province/city/district column")]),
