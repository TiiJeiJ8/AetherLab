...
app = dash.Dash(
    __name__,
    external_stylesheets=[dbc.themes.BOOTSTRAP, 'assets/CSS/topBar_style.css', 'assets/CSS/btn.css', 'assets/CSS/quantum.css'],
    external_scripts=['assets/JS/topBar_custom.js', 'assets/JS/neo.js', 'assets/JS/interaction.js'],
