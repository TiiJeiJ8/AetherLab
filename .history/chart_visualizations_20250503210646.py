    ...
    try:
        ...
        if fig:
            ...
            if not final_x_title:
                ...
                elif chart_type == 'heatmap' and not pivot_success: final_x_title = 'value'
                else: final_x_title = ''
            ...
            if not final_y_title:
                ...
                elif chart_type == 'heatmap': final_y_title = (str(y_axis_list[0]) if y_axis_list else 'Y') if pivot_success else 'value'
