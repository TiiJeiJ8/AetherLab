...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // 检查容器是否存在
    console.log('小球容器:', document.getElementById('animated-balls'));

    // 检查小球数量
    console.log('生成的小球数量:',
        document.getElementById('animated-balls').children.length);

    // 检查第一个小球的样式
    const firstBall = document.querySelector('.ball');
    console.log('首个小球样式:', firstBall?.style.cssText);
