        ...
        dbc.Container([
            ...
            dbc.Row([
                dbc.Col([
                    ...
                    html.H6("---------- Present by TiiJeiJ8 ----------", className="text-center mb-2 text-light d-inline", style={'margin-top': 'auto'}),
    ...
    dbc.Container([
        ...
        dbc.Row([
            ...
            dbc.Col([
                ...
                # New Analysis Card
                dbc.Card([
                    dbc.CardHeader(html.H4("Data import", className="text-info")),
                    dbc.CardBody([
                        dcc.Upload(
                            id='upload-data',
                            children=html.Div(['Drag or  ', html.A('选择文件', className="text-primary"), ' (CSV, Excel, JSON)']),
                            style={
                                'width': '100%', 
                                'height': '60px', 
                                'lineHeight': '60px', 
