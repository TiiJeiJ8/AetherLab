...
data_preprocessing_layout = html.Div([
    ...
    html.Div(children=[
        ...
        dbc.Container([
            ...
            dbc.Row([
                dbc.Col([
                    html.H1("Fuck-Charts", className="text-center mb-2 text-light d-inline dynamic-gradient-text", style={'margin-top': 'auto'}),
                ...
                dbc.Col([
                    ...
                    dbc.DropdownMenu(
                        [
                            dbc.DropdownMenuItem("Data Preprocessing", id="data-preprocess-btn", href='/data-preprocessing', disabled=),
