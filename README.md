...
> 一个强大的数据可视化和图表生成平台，提供25+种图表类型和智能数据处理功能
...
AetherLab 是一个现代化的数据可视化平台，专为数据分析师和开发者设计。它提供了直观的界面和强大的功能，帮助用户快速创建专业的数据可视化图表。

❕ **架构重构中**: 为了提高可维护性和开发效率，我们正在将原有的紧密耦合架构重构为前后端分离架构。💪
